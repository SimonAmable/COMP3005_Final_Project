...
-- we should change health metrics to contrete attributes to choose from IMO
CREATE TABLE IF NOT EXISTS health_Metrics(
metric_id SERIAL PRIMARY KEY,
member_metric_id INT REFERENCES Members(member_id),
goal_name VARCHAR(255) NOT NULL,
goal_desciption VARCHAR(255) NOT NULL
);

-- skipping commits To -> exersize Routines
